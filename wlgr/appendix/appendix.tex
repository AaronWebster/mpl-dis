\begin{figure}
	\begin{center}
		...
		\foreach \ix in {0,...,12} {
			...
			\end{tikzpicture}
			\includegraphics[width=12.0cm]{wlgr/primarystripes/\ix.eps}
			\node[anchor=west] at (0.05,0.5) {\ix};
		}
		% Last one with labels
		\begin{tikzpicture}[x=1.5cm, y=1.5cm]
			\input{wlgr/common/permute14}
		\end{tikzpicture}
		\includegraphics[width=12.0cm]{wlgr/primarystripes/14.eps}
		\node[anchor=west] at (0.05,0.5) {14};
		\begin{tikzpicture}[x=1.5cm, y=1.5cm]
			\node at (-0.55,-0.3) {$\frac{7\pi}{4}$};
			\node at (-1.55,-0.3) {$\frac{6\pi}{4}$};
			\node at (-2.55,-0.3) {$\frac{5\pi}{4}$};
			\node at (-3.55,-0.3) {$\pi$};
			\node at (-4.55,-0.3) {$\frac{3\pi}{4}$};
			\node at (-5.55,-0.3) {$\frac{\pi}{2}$};
			\node at (-6.55,-0.3) {$\frac{\pi}{4}$};
			\node at (-7.55,-0.3) {$0$};
		\end{tikzpicture}
	\end{center}
...
\begin{figure}
	\begin{center}
		...
		\foreach \ix in {0,...,12} {
			...
			\includegraphics[width=12.0cm]{wlgr/primarystripes/\ix.-intensity.eps}
			\node[anchor=west] at (0.05,0.5) {\ix};
		}
		...
		\begin{tikzpicture}[x=1.5cm, y=1.5cm]
			\input{wlgr/common/permute14}
		\end{tikzpicture}
		\includegraphics[width=12.0cm]{wlgr/primarystripes/14.-intensity.eps}
		\node[anchor=west] at (0.05,0.5) {14};
		\begin{tikzpicture}[x=1.5cm, y=1.5cm]
			\node at (-0.55,-0.3) {$\frac{7\pi}{4}$};
			\node at (-1.55,-0.3) {$\frac{6\pi}{4}$};
