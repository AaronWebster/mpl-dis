...
\begin{figure}
	\centering
	\begin{tikzpicture}[scale=0.7, x=1.1cm, y=1.1cm]
		% Filled gray boxes
		\fill[gray] (-1.5,0) rectangle (0,1.5);
		\fill[gray] (-1.5,1.5) rectangle (0,3);
		\fill[gray] (-1.5,3) rectangle (0,4.5);
		\fill[gray] (-1.5,4.5) rectangle (0,6);
		% Draw outlines for gray boxes
		\draw (-1.5,0) rectangle (0,1.5);
		\draw (-1.5,1.5) rectangle (0,3);
		\draw (-1.5,3) rectangle (0,4.5);
		\draw (-1.5,4.5) rectangle (0,6);
		% Roman numerals
		\node at (-0.75,0.75) {\Rmnum{4}};
		\node at (-0.75,2.25) {\Rmnum{3}};
		\node at (-0.75,3.75) {\Rmnum{2}};
		\node at (-0.75,5.25) {\Rmnum{1}};

		% Empty boxes with text
		\draw (0,0) rectangle (6,1.5);
		\draw (0,1.5) rectangle (6,3);
		\draw (0,3) rectangle (6,4.5);
		\draw (0,4.5) rectangle (6,6);
		\node at (3,5.25) {single scattering involving the tip};
		\node at (3,3.75) {single scattering not involving the tip};
		\node at (3,2.25) {multiple scattering involving the tip};
		\node at (3,0.75) {multiple scattering not involving the tip};
	\end{tikzpicture}
