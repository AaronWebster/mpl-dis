...
\newcommand{\fresnelpropzA}{$z=\SI{0.05}{\milli\meter}$}
\newcommand{\fresnelpropzB}{$z=\SI{0.25}{\milli\meter}$}
\newcommand{\fresnelpropzC}{$z=\SI{0.5}{\milli\meter}$}
\newcommand{\fresnelpropzD}{$z=\SI{1.0}{\milli\meter}$}
\newcommand{\fresnelpropzE}{$z=\SI{2.5}{\milli\meter}$}
\newcommand{\fresnelpropzF}{$z=\SI{5.0}{\milli\meter}$}
\newcommand{\fresnelpropzG}{$z=\SI{10.0}{\milli\meter}$}
\newcommand{\fresnelpropzH}{$z=\SI{50.0}{\milli\meter}$}

% base directory
\newcommand{\fresnelpropbasedir}{wigglespropagate/lah79-ag-air-1050}
