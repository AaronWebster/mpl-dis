...
began in the early 1980's with work by \name{Liedberg}, \name{Nylander} and
...
\name{Richie}.  As particular example, in 2005 and 2007, two
...
\name{Gregory}~\cite{schumann2008near}.  Interestingly, observation of the
...
single scatterer among a fixed background, \name{Schumann} showed the
