...
breadth of phenomena discovered since \name{Richie}.  As an example
particular to this dissertation, in 2005 and 2007, two
...
Kretschmann-Raether type) illuminated with focused Gaussian beams.
...
\todo{random does not imply freedom from correlations}
...
the seemingly random fluctuations in the output channel contain correlations which
...
The important implications of such speckle correlations were perhaps best
summarized by \name{Berkovits} and
