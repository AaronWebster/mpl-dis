Having shown the existence of \glspl{spp} under the momentum-matching conditions
...
According to the dispersion relation, \Equation{eqn:dispersion1}, \glspl{spp} are
...
The above conditions are satisfied when using the Kretschmann \gls{atr}
...
$\epsilon_2=\complexnum{-11.361+1.923i}$ (gold), layer $D_3$ $\epsilon_3=1.33$
...
``conventional \glspl{spp}'', and in \Figure{fig:fresnelnearfieldlrspp} for the
...
\Figure{fig:fresnelnearfieldspp} and \Figure{fig:fresnelnearfieldlrspp}
...
the origin, as a small \SI{3}{\micro\meter} $\times$ \SI{5}{\micro\meter} ellipse with \glspl{spp} propagating
...
\begin{figure}[ht]
	...
	\caption{Near and far field intensities for excitation of conventional \glspl{spp}
		in a three-layer system. $\lambda_0=\SI{660}{\nano\meter}$, $n_1 =
			\num{1.5142}$, $n_2=\complexnum{0.2843 + 3.3825i}$, and $n_3=1.3310$.  The thickness of the metal layer is
		\SI{45}{\nano\meter}.}
