...
\todo{say 1e-20 is zero, but we have it there for numerical reasons}
...
First, note that the Lorentz-Drude model is much better \todo{define
...
exclusively.
\todo{define sign convention}
\todo{why do you use lorentz-drude model in the first place}
