...
two dimensions; \todo{why restrict to TM polarisation} in this case the $x$-$z$ plane as shown in
...
$\mathbf{H}$ must be orthogonal to $\mathbf{E}$. 
\begin{align}
...
\end{align}
\todo{not the components, either e or h, since E_z is perpendicular to the
interface}
...
\todo{maybe refer to media with indicies, not e1, e2, e3, etc}
