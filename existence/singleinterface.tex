\begin{figure}[ht]
 ...
 \caption{Geometry and coordinate system for a single interface system.}
 \label{fig:singleinterfacegeo}
\end{figure}
With plane wave solutions to Maxwell's equations in hand, boundary
conditions consistent with a single interface can be imposed.  At such an
