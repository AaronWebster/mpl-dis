...
geometry, shown in \Figure{fig:multilayergeo} is now considered.  It will
...
of the equation, shown in \Figure{fig:lrsppdispersionrelation}.
...
\SI{8}{\micro\meter} for gold.  The symmetric configuration increases the
propagation distance by a factor of 10, and the photonic crystal structure
has been reported to increase the propagation distance by a factor of
