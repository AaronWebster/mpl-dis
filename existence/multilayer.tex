...
propagation distances in the \textit{millimeter} range.  A typical three
layer system in the Kretschmann ATR configuration will exhibit SPP
propagation distances on the order of \SI{8}{\micro\meter} for gold.  The
...
propagation distance by a factor of 100~\cite{konopsky2009long}.
