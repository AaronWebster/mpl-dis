Physical properties of SPP propagation are derived from their complex spatial
...
real part of $k_x$ in \Equation{eqn:kayexx}~\cite{raether1997surface}.  When
$k_x$ is imaginary, \Equation{eqn:planewavexz} is evanescent in $x$ and the SPP
