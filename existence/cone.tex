...
functions, except in a limited scope in \Chapter{ch:scatteringmicro}, and
state that
\begin{equation}
...
Due to the \textit{double} enhancement factor in \Equation{eqn:guhacone},
light in the cone has a narrower linewidth than its specular counterpart in
the notch.  In \Figure{fig:conevsnotch} we show a simulated provfile of the
