The metal films were fabricated using a standard top-down plasma sputtering
...
Silver films were removed by immersion in \SI{70}{\percent} \ce{HNO3} for
...
\ce{HCl}.  The glass prisms were then sonicated in acetone to remove any
