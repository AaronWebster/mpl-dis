...
roughness came to use though an anecdote by
...
the sputtering procedure at the appropriate temperature.  In consideration
...
Fresnel reflection coefficient for a single interface at normal incidence in
terms of the refractive indices
\begin{equation}
r^s = \frac{n_1 - n_2}{n_1+n_2}
\end{equation}
and the reflectance $R^p=|r^p|^2$.  In other words, the Fresnel
reflectivity is
roughly proportional to the difference in refractive indices, and when
...
hydrophilic, and combined with the lowered surface tension
...
two reasons: gold has a significant amount of established bio-relevant
