...
%A magnetic sensor consisting of a prism coupler and a magnetic thin film has
%been theoretically proposed [11], but the Otto configuration of attenu- ated
%total reflection has been applied in the design, requiring the thickness of the
%air gap that exists between the prism and the thin film to be smaller than the
%light wavelength. This is necessary for efficient coupling of the evanescent
%wave to the film, and thus con- siderably limits any practical applications. In
%fact, effective coupling between the evanescent wave and the thin film can be
%achieved more simply and easily in the Kretschmann attenuated total reflec-
%tion configuration, in which the thin film is directly deposited on the surface
...
\Figure{fig:experimentalpicture} with its functional components annotated.  A
simplified schematic is also shown in \Figure{fig:experimentalsetup}.
...
Extra attention was not given to mechanical stability.  Though the quality
