...
\name{Edward~Tufte}~\cite{tufte1983visual}~\cite{tufte1991envisioning}.
...
processed using python and scipy/numpy.  Figure generation for QCM data 
visualization was converted from \texttt{MATLAB}/matlab2tikz to pure Python 
using numpy and palettable. Parallel execution when required
was done at FAU RRZE, Erlangen, Germany.  Multiple scattering code
