...
**Converted:**
- ✓ `qcm/figures/showtempair.m` → `generate_showtempair.py`
- ✓ `qcm/figures/showtempwater.m` → `generate_showtempwater.py`  
- ✓ `qcm/figures/showtempairwater.m` → `generate_temp_plots.py`
...
- Same functionality (4-subplot time series, air/water comparison)
...
% QCM chapter
\import{qcm/figures/}{showtempairwater}             % ✓ Generated by Python
```
...
|---------------------|-------------------|--------|
| QCM figure generation | generate_showtempair.py | ✓ Converted |
| QCM figure generation | generate_showtempwater.py | ✓ Converted |
| QCM figure generation | generate_temp_plots.py | ✓ Converted |
| ColorBrewer palettes | palettable.colorbrewer.qualitative.Set1_9 | ✓ Available |
| Array operations | numpy | ✓ Available |
| Other figures | Static .tex files (already generated) | ✓ Committed |
