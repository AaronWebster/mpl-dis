...
We now turn to study of the CF-QCM sensogram for different load situations.
...
=\SI{2.188+-0.006e-2}{\hertz\per\g}$.  The CF-QCM data shows similar
...
\Figure{fig:loadplot}(c).  Here, free streptavidin coated polystyrene particles,
