...
N\raisebox{0.25em}{\relsize{-2}\b{o}}~1 cover glass of nominal thickness
...
The next chapter presents the response of the CF-QCM under different load
...
Such phenomena have been tabulated in \Table{tbl:environmentaleffects}.
\begin{table}[ht]
  \centering
...
From \Table{tbl:environmentaleffects} it is apparent that the dominant source
...
\Figure{fig:qcmairtime}, a parametric plot of g-force verses temperature for
