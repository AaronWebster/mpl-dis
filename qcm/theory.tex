...
$x_\mathrm{q}=A_\mathrm{q}\me^{\mi \omega t}$ and $x_\mathrm{L}=A_\mathrm{L}\me^{\mi \omega
		t}$, can be solved for the system eigenfrequencies.
Here, $N_\mathrm{L}$ is a number surface density (number per unit area) for discrete
loads.
