...
Naturally, \glspl{qcm} do not come without their own disadvantages. The underlying
...
%prediction of the response of a \gls{qcm} for samples under centrifugal force.
