...
the crystal has a reported value~\cite{valdois2794influence} of $\df/\Delta
	g =\SI{2.188(6)e-2}{\hertz\per\g}$.  Our instrument shows similar behavior:
$\df/\Delta g =\SI{2.682(23)e-2}{\hertz\per\g}$ in the loading
...
but we find the value to be $\dg/\Delta g = \SI{9.203(171)e-4}{\hertz\per\g}$.
...
load was found to be linear and smaller than that of air: $\df/\Delta g=
	...
	\SI{2.865(73)e-3}{\hertz\per\g}$.  We observe that these acceleration
...
linear decrease ($\dg=\SI{-2.9120(95)}{\hertz\per\g}$) in the
...
STE buffer alone ($\df=\SI{-0.3260(29)}{\hertz\per\g}$, and $\dg$
...
shear modulus of $G_\mathrm{L}=(10+50\,\mi)\,\si{\kilo\pascal}$ and density
...
$G_\mathrm{L}=(78+78\,\mi)\,\si{\kilo\pascal}$. Again the density was assumed to
...
complex shear modulus of $G_\mathrm{L}=(0.659+0.235\,\mi)\,\si{\giga\pascal}$.
