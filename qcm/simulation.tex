...
is a sliding wall and is given a tangential speed of $\dot{u}_\perp = \mi
...
\Figure{fig:suppshearwave}.  For this, we express the shear evanescent wave
...
predicts $\delta\approx\SI{252}{\nano\meter}$.  This is in good agreement
with the simulation data, shown in \Figure{fig:suppshearwave}.
...
\end{axis}
\end{tikzpicture}
\caption{QCM shear wave decay at \SI{5}{\mega\hertz}, obtained with the
finite element simulation, compared with theory (\Equation{eqn:viscoshear}).}
