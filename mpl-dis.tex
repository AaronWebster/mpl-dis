...
are scattered in a prism coupled setup.  The easiest way of understanding
this is though a simplified dipiction of the experimental setup, shown in
\Figure{fig:kretschmanngeo}.  
...
% should probably say something here about how this is an extension of the
% work should probably also introduce the "thrust", the moving scatterer
% problem and the add a scatter problem
