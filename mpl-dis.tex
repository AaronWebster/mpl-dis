...
The experimental setup for excitation of SPPs is shown in
\Figure{fig:sppexperimentalsetup}.  Light from a \SI{660}{\nano\meter}
diode laser is coupled into an optical fiber and 
...
The stability of the spin coater and the range of speeds it offers is
shown in \Table{tbl:spincoatererror}.  Perhaps the most obvious downside of
the ESC controller is that it does not 
