...
interaction of a single scatterer can be precisely controlled.

The analysis of our SPP experiments has been greatly advanced by
theoretical treatment of elastic multiple scattering through disordered
media.  This was estabilished with the seminal paper by \name{Feng},
\name{Lee}, \name{Stone}, and \name{Douglas}~\cite{feng1988correlations} on
the subject of correlations in transmitted waves in mesoscopic systems in
the diffusive regime.  We borrow mainly from later analysis by
\name{Berkovits} and \name{Feng}~\cite{berkovits1994correlations} who
extended the theoretical treatment to optical waves.  This brought about
several useful experimental tools such as diffusive wave spectroscopy
\cite{pine1988diffusing}.  Through these calculations it was established
