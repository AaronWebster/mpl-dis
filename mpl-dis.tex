...
is though the experimental setup, shown in \Figure{fig:kretschmanngeo}.  
...
Light is incident from an angle $\theta$ greater than the critical angle,
...
it's $k$-vector in the $k_x$-$k_y$ plane.  When this happens, light will
appear on an thin annular cone at (nearly) the same angle as the dark band
in the specular direction.

The conically scattered light is what we're interested in.  Its light is
much less intense than

Surface plasmon resonance has been the topic of an amazing number of
theoretical and experimental endevors since their discovery in the late
1950's
...
to make this explicit.  To this accord, the following is a list of new
results presented here
\begin{description}
\item[Interference of Directionally Scattered SPPs]
...
Directionally scattered light from SPPs excited in the Kretschmann
configuration.
...
\section{Colophon}
This document was typeset using pdf\TeX {\verb 3.1415926-2.5-1.40.14}. All
