...
\tikzexternalize[prefix=external/,mode=list and make]% externalize

%\newcommand{\inputtikz}[1]{% 
%\ifdefined\fakejobname% 
%\ifthenelse{\equal{\jobname}{\detokenize{external/#1-out}}}{% 
%\beginpgfgraphicnamed{external/#1-out}\input{external/#1.tex}\endpgfgraphicnamed}{}% 
%\else% 
%\beginpgfgraphicnamed{external/#1-out}\input{external/#1.tex}\endpgfgraphicnamed% 
%\fi} 

% package has problems with externalization, disable it here for
% convienence
