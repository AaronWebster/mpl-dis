...
% Ultra-simple transparent wrapper that just passes through content
% This prevents TeX capacity overflow with PSTricks nested in \multido loops
% The simplest possible implementation to avoid any macro expansion issues
\long\def\subfigure#1{#1}
