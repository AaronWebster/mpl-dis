...
% NOTE: Currently disabled due to pdflatex incompatibility
% TODO: Either convert to TikZ/PGF or use auto-pst-pdf with LuaLaTeX
%\usepackage{pstricks}
...
% Note: subfigure counter and environment are provided by subcaption package (line 28)
% Legacy skip variable for WLGR appendix compatibility
\newskip\subfigbottomskip
\subfigbottomskip=0pt

% Roman numeral command for WLGR content
\makeatletter
...
% Externalize tikz - disabled due to compilation issues in CI/CD environment
