...
results by \name{Baida} (\Figure{fig:baidacompare}) are very similar to what
was obtained in \Figure{fig:fresnelprop}.  In this sense,
...
(\Section{sec:sppphysicalchar}), the results match that of \name{Baida} and of
