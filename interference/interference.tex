...
this pattern in the cone is shown in \Figure{fig:coneintrofig} for a silver
...
specular reflection.  This is contrary to several literature explanations;
we believe our explanation rectifies such discrepancy.
...
the distance in \Figure{fig:fresnelprop} for which the oscillations
disappear.
