...
\begin{tabular}{cc}
	...
	\begin{tikzpicture}[baseline,trim axis left]
		\begin{axis}[restrict x to domain=31:100,normalise={30}{30}]
			...
			{\includegraphics[height=0.11\textwidth,keepaspectratio]{images/color/near02.png}};
	...
	\begin{tikzpicture}[baseline,trim axis right]
		\begin{axis}[restrict x to domain=-9:60,normalise={-10}{-10}]
			...
			\node[anchor=base east] at (0.430\textwidth,-0.009\textwidth)
			{\includegraphics[height=0.11\textwidth,keepaspectratio]{images/color/conenear.png}};
			\addlegendentry{$z=\SI{10}{\micro\meter}$}
		\end{axis}
	\end{tikzpicture}%
	\\
	\begin{tikzpicture}[baseline,trim axis left]
		\begin{axis}[restrict x to domain=475:725,normalise={500}{}]
			...
			\node[anchor=base east] at (0.430\textwidth,-0.009\textwidth)
			{\includegraphics[height=0.11\textwidth,keepaspectratio]{images/color/midfield.png}};
	...
	\begin{tikzpicture}[baseline,trim axis right]
		\begin{axis}[restrict x to domain=1100:1350,normalise={1100}{}]
			...
			\node[anchor=base east] at (0.430\textwidth,-0.009\textwidth)
			{\includegraphics[height=0.11\textwidth,keepaspectratio]{images/color/conemid03.png}};
			\addlegendentry{$z=\SI{0.1}{\milli\meter}$}
		\end{axis}
	\end{tikzpicture}%
	\\
	\begin{tikzpicture}[baseline,trim axis left]
		\begin{axis}[
			...
			\node[anchor=base east] at (0.430\textwidth,-0.009\textwidth)
			{\includegraphics[height=0.11\textwidth,keepaspectratio]{images/color/farfield02.png}};
		\end{axis}
	\end{tikzpicture}%
	               &
	\hspace{-0.75cm}
	\begin{tikzpicture}[baseline,trim axis right]
		\begin{axis}[
			...
			\addlegendentry{$z=\SI{100}{\milli\meter}$}
			\node[anchor=base east] at (0.430\textwidth,-0.009\textwidth)
			{\includegraphics[height=0.11\textwidth,keepaspectratio]{images/color/321-9.png}};
		\end{axis}
	\end{tikzpicture}%
\end{tabular}
\end{document}
