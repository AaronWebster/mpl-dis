...
This work is roughly organized in the following way.  \Chapter{ch:foreword}
is what you are currently reading.  \Chapter{ch:spp} lays out the
...
chapters form the mathematical (\Chapter{ch:spp}) and physical
...
Finally, in \Chapter{ch:scattmicro} we look at the influence of the cone
