Consider an SPP excited by a focussed beam in a prism coupled setup.  Without
loss of generality, the center of the focussed beam is defined as the origin
