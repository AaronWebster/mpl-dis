...
are often de-emphasized in favor of a quantitative and repeatable assay.  Such
...
operation extending their versatility to other types of sensing relevant to
...
sensor surface, however the SPPs themselves also possess high spatial
resolution beyond the diffraction limit; a property which is typically
absent as specific feature of the SPR sensorgram.  In this work however, it
is shown that by considering optical speckle from single and multiply
scattered SPPs inherent in the SPR signal, an entirely new set of
information can be obtained describing the underlying scattering
...
viscoelasticity, as well as an affinity sensor for mass
...
biomechanical properties \textit{in situ} and in real time.  
\end{abstract}
